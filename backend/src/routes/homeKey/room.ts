...
roomRoute
  .route("/exportListRoomAbleRent/:id")
  .get(RoomController.listRoomAbleRentByIdRoomOfMotel);

roomRoute
  .route("/quickDepositByAdmin/")
  .post(RoomController.quickDepositByAdmin);
roomRoute
  .route("/quickDepositManyRoomsByAdmin/")
  .post(RoomController.quickDepositManyRoomsByAdmin);

roomRoute.route("/quickRentByAdmin/").post(RoomController.quickRentByAdmin);
roomRoute
  .route("/quickRentManyRoomsByAdmin/")
  .post(RoomController.quickRentManyRoomsByAdminV2);
