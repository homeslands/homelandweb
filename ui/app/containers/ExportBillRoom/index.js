...
export function ExportBillRoom(props) {
  ...
  let totalWifiNAction = totalWifiN;
  let unitPriceWifiNLocal = unitPriceWifiN;
  ...
  const handleChangeWifiN = e => {
    unitPriceWifiNLocal = totalWifiNAction;
    const typeWifiN = e.target.value;
    const result = unitPriceWifiN * typeWifiN;
    totalWifiNAction = result;
    return result;
  };
  ...
  const downloadFile = async payload => {
    const requestUrl =
      urlLink.api.serverUrl + urlLink.api.motelCreateOrderAndPdf;
    try {
      ...
      notificationController.error(
        'Lỗi tạo hóa đơn mới, vui lòng kiểm tra lại hóa đơn trước đó đã được thanh toán hay chưa',
      );
      // setFlag(!flag);
    }
  };
                ...
                <Col md={3}>
                  {
                    <FormattedMessage {...messages.startFilter}>
                      {msg => (
                        <InputForm
                          label={<FormattedMessage {...messages.startFilter} />}
                          placeholder={msg}
                          name="dayStart"
                          icon="fa fa-user"
                          type="date"
                ...
                <Col md={3}>
                  {
                    <FormattedMessage {...messages.endFilter}>
                      {msg => (
                        <InputForm
                          label={<FormattedMessage {...messages.endFilter} />}
                          placeholder={msg}
                          name="dayEnd"
                          icon="fa fa-user"
                          type="date"
                  ...
                  <div>
                    <form onSubmit={handleSubmit}>
                      ...
                      <Row className="infor" style={{ paddingTop: '20px' }}>
                        <Col md={3}>
                          {
                            <FormattedMessage {...messages.expenseWifiN}>
                              {msg => (
                                <InputForm
                                  label={
                                    <FormattedMessage
                                      {...messages.expenseWifiN}
                                    />
                                  }
                                  placeholder={msg}
                                  disabled
                                  name="expenseWifi"
                                  icon="fa fa-user"
                                  value={values.expenseWifiN}
                                  touched={touched.expenseWifiN}
                                  error={errors.expenseWifiN}
                                  autoComplete="expenseWifiN"
                                  onChange={evt => {
                                    handleChange(evt);
                                  }}
                                  onBlur={handleBlur}
                        ...
                        <Col md={3}>
                          {
                            <FormattedMessage {...messages.typeWifiN}>
                              {msg => (
                                <InputForm
                                  label={
                                    <FormattedMessage {...messages.typeWifiN} />
                                  ...
                                  name="typeWifi"
                                  icon="fa fa-user"
                                  value={values.typeWifiN}
                                  touched={touched.typeWifiN}
                                  error={errors.typeWifiN}
                                  autoComplete="typeWifiN"
                                  onChange={evt => {
                                    handleChange(evt);
                                    setFieldValue(
                                      'totalWifiN',
                                      handleChangeWifiN(evt),
                                    );
                                    setFieldValue(
                                      'totalAndTaxAll',
                                      handleTotalAndTaxAllAction(
                        ...
                        <Col md={3}>
                          {
                            <FormattedMessage {...messages.unitPriceWifiN}>
                              {msg => (
                                <InputForm
                                  label={
                                    <FormattedMessage
                                      {...messages.unitPriceWifiN}
                                    />
                                  }
                                  placeholder={msg}
                                  disabled
                                  name="unitPriceWifiN"
                                  icon="fa fa-user"
                                  value={values.unitPriceWifiN}
                                  touched={touched.unitPriceWifiN}
                                  error={errors.unitPriceWifiN}
                                  autoComplete="unitPriceWifiN"
                                  onChange={evt => {
                                    handleChange(evt);
                                  }}
                                  onBlur={handleBlur}
                            ...
                            <FormattedMessage {...messages.totalWifiN}>
                              {msg => (
                                <InputForm
                                  ...
                                  name="totalWifiN"
                                  icon="fa fa-user"
                                  value={values.totalWifiN}
                                  touched={touched.totalWifiN}
                                  error={errors.totalWifiN}
                                  autoComplete="totalWifiN"
                                  onChange={evt => {
                                    handleChange(evt);
                                  }}
                                  onBlur={handleBlur}
